...
public class ContatosControle {
	...
	static {
		LISTA_CONTATOS.addAll(Arrays.asList(new Contato("1", "Adriano", "+55 88 98193 5976"),
				new Contato("2", "João", "+55 11 00000 0000"), new Contato("3", "Normandes", "+55 34 00000 0000"),
				new Contato("4", "Thiago", "+55 34 00000 0000"), new Contato("5", "Alexandre", "+55 34 00000 0000")));
	}
...
/////////////////////////////////////////////////////////////////////////////
	...
	//ACEITOU PUT ao inserir no PROPERTIES: spring.mvc.hiddenmethod.filter.enabled=true 
	//@RequestMapping(value = "/contatos/{id}", method = RequestMethod.POST) 
